function[addistfday,noaddistfday,addistdday,noaddistdday,addistspday,noaddistspday,...
    addisttday,noaddisttday,advelspday,noadvelspday,id_age] = finddist_andgroup_onevoc(start1,end1,d1,f1,r1,age1,id1,humlist1)

%Ritwika VPS, UC Merced

%finds step sizes and concatenates subrecordngs from same infant on same
%day - only subsequent vocalisation for response - use only for
%humanlabelled data
