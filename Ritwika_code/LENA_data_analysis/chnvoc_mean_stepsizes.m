...
writetable(T_binary,'ch_meansteps_binary_forstats.csv')
...
writetable(T_2voc,'ch_meansteps_2voc_forstats.csv')
...
writetable(T_3bin,'ch_meansteps_3bin_forstats.csv')
...
chn_mean_steps = table(mean_v_sp,std_v_sp,CI_v_sp_neg,CI_v_sp_pos,num_v_sp,...
...
writetable(chn_mean_steps,'adresp2ch_mean_stepsize.csv')
