function [median_sp,median_d,median_f,median_t,median_vsp,age,id,withch,samplesi] = median_fn(distsp_ad_day,distsp_noad_day,distd_ad_day,distd_noad_day,...
...
median_ch_vsp(j,1) = median(velsp_ad_day{i});
median_noch_vsp(j,1) = median(velsp_noad_day{i});
