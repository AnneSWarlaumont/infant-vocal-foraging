...
save('adresp2ch_stepsizes_humlab.mat','HUMad_distf','HUMnoad_distf','HUMad_distd','HUMnoad_distd','HUMad_distsp','HUMnoad_distsp',...
    'HUMad_distt','HUMnoad_distt','HUM_idage','LENAad_distf','LENAnoad_distf','LENAad_distd','LENAnoad_distd'...
    ,'LENAad_distsp','LENAnoad_distsp','LENAad_distt','LENAnoad_distt','LENA_idage')
...
save('chresp2ad_stepsizes_humlab.mat','HUMch_distf','HUMnoch_distf','HUMch_distd','HUMnoch_distd','HUMch_distsp','HUMnoch_distsp',...
    'HUMch_distt','HUMnoch_distt','HUM_idage','LENAch_distf','LENAnoch_distf','LENAch_distd','LENAnoch_distd',...
    'LENAch_distsp','LENAnoch_distsp','LENAch_distt','LENAnoch_distt','LENA_idage')                                                          
%we find parameters of AIC best fits of step size distributions
