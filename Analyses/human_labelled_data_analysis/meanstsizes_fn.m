function [ch_mean_steps,T_binary,T_2voc] = meanstsizes_fn(adr_st,adr_en,adresponse,adr_zlogf,adr_zd,id1,age1,humlist1)
...
for i  = 1:length(id_age)
    ...
    if (strcmp(id_age{i},sprintf('%s_%d_%s',id1{j},age1(j),humlist1{j})) == 1) && (isempty(distf_subrec{j}) == 0) 
