...
% Loads in all the adult response data for adult vocalisations. The
% response data are in the ChildResponsesToAdult files within the chresp
...
% using the responses.pl script. This .m file only gives whether a child
% response was received (Y), not received (N), or was not applicable (NA),
% as well as start and end times of the adult vocalisation that the Y, N or
% NA response is applicable to. Note that both MAN and FAN speaker types
% are considered as adult and as such, these files do not contain speaker
% type details.
...
% one subrecording to the beginning of the next, despite there
