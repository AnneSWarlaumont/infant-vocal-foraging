...
#for eg, if we were cdoing lmer stats for step size distributions in frequency dimension, then only distributions best fit to an exponential would be considered
