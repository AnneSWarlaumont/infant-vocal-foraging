...
ind = 90; %floor(1 + (144-1).*rand(1,1));

figure;
hold all
[aic_fad,ffit,p] = aicnew(disttim_ch_day{ind},[0 0 0 0],0);
aicmat = zeros(1,4);
aicmat(ffit) = 1; %indicates best fit
[xaxis,yaxis_fit,yaxis_dat] = aicplots(disttim_ch_day{ind},aicmat,0); %generates fit data for best fit
