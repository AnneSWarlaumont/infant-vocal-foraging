...
hold all
title('\bf{(child a)}')
plot(aa.age(aa.response == 1),aa.median_sp(aa.response == 1),'bs','MarkerSize',15) %wr is b, wor is r
plot(aa.age(aa.response == 0),aa.median_sp(aa.response == 0),'rs','MarkerSize',15)
...
hold all
title('\bf{(b)}')
plot(aa.age(aa.response == 1),aa.median_t(aa.response == 1),'bs','MarkerSize',15) %wr is b, wor is r
plot(aa.age(aa.response == 0),aa.median_t(aa.response == 0),'rs','MarkerSize',15)
...
title('\bf{(a)}')
plot(aa.age(aa.response == 1),aa.median_sp(aa.response == 1),'ks','MarkerSize',15)
plot(aa.age(aa.response == 0),aa.median_sp(aa.response == 0),'gs','MarkerSize',15)
...
aa = readtable('median_chresp2ad.csv');
title('\bf{(b)}')
plot(aa.age(aa.response == 1),aa.median_t(aa.response == 1),'ks','MarkerSize',15)
plot(aa.age(aa.response == 0),aa.median_t(aa.response == 0),'gs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.sp_fit == 2),aa.lognspmu(aa.response == 1 & aa.sp_fit == 2),'bs','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.sp_fit == 2),aa.lognspmu(aa.response == 0 & aa.sp_fit == 2),'rs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.sp_fit == 2),aa.lognspsig(aa.response == 1 & aa.sp_fit == 2),'bs','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.sp_fit == 2),aa.lognspsig(aa.response == 0 & aa.sp_fit == 2),'rs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.sp_fit == 2),aa.lognspmu(aa.response == 1 & aa.sp_fit == 2),'ks', 'MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.sp_fit == 2),aa.lognspmu(aa.response == 0 & aa.sp_fit == 2),'gs', 'MarkerSize',15)
ll =legend({'\bf{WR}','\bf{WOR}'},'FontSize',24);
...
plot(aa.age(aa.response == 1 & aa.sp_fit == 2),aa.lognspsig(aa.response == 1 & aa.sp_fit == 2),'ks','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.sp_fit == 2),aa.lognspsig(aa.response == 0 & aa.sp_fit == 2),'gs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.tim_fit == 2),aa.logntimmu(aa.response == 1 & aa.tim_fit == 2),'bs','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.tim_fit == 2),aa.logntimmu(aa.response == 0 & aa.tim_fit == 2),'rs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.tim_fit == 2),aa.logntimsig(aa.response == 1 & aa.tim_fit == 2),'bs','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.tim_fit == 2),aa.logntimsig(aa.response == 0 & aa.tim_fit == 2),'rs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.tim_fit == 4),aa.paretotimxmin(aa.response == 1 & aa.tim_fit == 4),'ks', 'MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.tim_fit == 4),aa.paretotimxmin(aa.response == 0 & aa.tim_fit == 4),'gs', 'MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.tim_fit == 4),aa.paretotimsig(aa.response == 1 & aa.tim_fit == 4),'ks','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.tim_fit == 4),aa.paretotimsig(aa.response == 0 & aa.tim_fit == 4),'gs','MarkerSize',15)
...
plot(aa.age(aa.response == 1),aa.median_f(aa.response == 1),'bs','MarkerSize',15) %wr is b, wor is r
plot(aa.age(aa.response == 0),aa.median_f(aa.response == 0),'rs','MarkerSize',15)
ylabel('\bf{Median}','FontSize',40)
...
plot(aa.age(aa.response == 1  & aa.f_fit == 3),aa.expf(aa.response == 1 & aa.f_fit == 3),'bs','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.f_fit == 3),aa.expf(aa.response == 0 & aa.f_fit == 3),'rs','MarkerSize',15)
...
plot(aa.age(aa.response == 1),aa.median_f(aa.response == 1),'ks','MarkerSize',15)
plot(aa.age(aa.response == 0),aa.median_f(aa.response == 0),'gs','MarkerSize',15)
...
plot(aa.age(aa.response == 1 & aa.f_fit == 3),aa.expf(aa.response == 1 & aa.f_fit == 3),'ks', 'MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.f_fit == 3),aa.expf(aa.response == 0 & aa.f_fit == 3),'gs', 'MarkerSize',15)
...
plot(aa.age(aa.response == 1),aa.median_d(aa.response == 1),'bs','MarkerSize',15) %wr is b, wor is r
plot(aa.age(aa.response == 0),aa.median_d(aa.response == 0),'rs','MarkerSize',15)
ylabel('\bf{Median}','FontSize',40)
...
plot(aa.age(aa.response == 1  & aa.d_fit == 3),aa.expd(aa.response == 1 & aa.d_fit == 3),'bs','MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.d_fit == 3),aa.expd(aa.response == 0 & aa.d_fit == 3),'rs','MarkerSize',15)
ylabel('\bf{\lambda}','FontSize',40)
...
plot(aa.age(aa.response == 1),aa.median_d(aa.response == 1),'ks','MarkerSize',15)
plot(aa.age(aa.response == 0),aa.median_d(aa.response == 0),'gs','MarkerSize',15)
ylabel('\bf{Median}','Interpreter','latex','FontSize',40)
...
plot(aa.age(aa.response == 1 & aa.d_fit == 3),aa.expd(aa.response == 1 & aa.d_fit == 3),'ks', 'MarkerSize',15)
plot(aa.age(aa.response == 0 & aa.d_fit == 3),aa.expd(aa.response == 0 & aa.d_fit == 3),'gs', 'MarkerSize',15)
ylabel('\bf{\lambda}','Interpreter','tex','FontSize',40)
