...
fad2ch = fittypesum(aa.f_fit(aa.response == 1));
fnoad2ch = fittypesum(aa.f_fit(aa.response == 0));
dad2ch = fittypesum(aa.d_fit(aa.response == 1));
dnoad2ch = fittypesum(aa.d_fit(aa.response == 0));
spad2ch = fittypesum(aa.sp_fit(aa.response == 1));
spnoad2ch = fittypesum(aa.sp_fit(aa.response == 0));
timad2ch = fittypesum(aa.tim_fit(aa.response == 1));
timnoad2ch = fittypesum(aa.tim_fit(aa.response == 0));
clear aa

aa = readtable('chr2ad_stepsizedist.csv');
fch2ad = fittypesum(aa.f_fit(aa.response == 1));
fnoch2ad = fittypesum(aa.f_fit(aa.response == 0));
dch2ad = fittypesum(aa.d_fit(aa.response == 1));
dnoch2ad = fittypesum(aa.d_fit(aa.response == 0));
spch2ad = fittypesum(aa.sp_fit(aa.response == 1));
spnoch2ad = fittypesum(aa.sp_fit(aa.response == 0));
timch2ad = fittypesum(aa.tim_fit(aa.response == 1));
timnoch2ad = fittypesum(aa.tim_fit(aa.response == 0));
